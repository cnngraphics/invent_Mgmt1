    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">Inventory Manager</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="page-scroll">
                        <a href="#portfolio">My Inventory</a>
                    </li>
                    <li class="page-scroll">
            ...
            <div class="row">
                <div class="col-sm-4 portfolio-item">
                    ...
                    <div class="single-item item-bordered">
                        <div class="single-item item-bordered item-block"></div>
                        <div class="btn btn-primary" id="minus">-</div>
                        <div class="btn btn-primary disabled" id="sum">0</div>
                        <div class="btn btn-primary" id="plus">+</div>
                    </div>
